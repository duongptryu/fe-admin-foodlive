...
import TableRst from "./components/TableRst";
import TableRstAsc from "./components/TableUserAsc";
...
function Home() {
  ...
  const onChange = (e) => {
    if (e.target.value == "user") {
      ...
      setRadioValue("rating_desc");
    } else {
      setRadioValue("rating_asc");
    }
  };
          ...
          <Col xs={24} sm={24} md={12} lg={12} xl={16} className="mb-24">
            <Card bordered={false} className="criclebox cardbody h-full">
              <div className="project-ant">
                <div>
                  <Title level={5}>Top five</Title>
                  <Paragraph className="lastweek">
                    {radioValue == "user" && "User By Order"}
                    {radioValue == "rating_desc" && "Highest Rating Restaurant"}
                    {radioValue == "rating_asc" && "Lowest Rating Restaurant"}
                  </Paragraph>
                </div>
                <div className="ant-filtertabs">
                  <div className="antd-pro-pages-dashboard-analysis-style-salesExtra">
                    <Radio.Group onChange={onChange} defaultValue="user">
                      ...
                      <Radio.Button value="rating_desc">
                        Top High Rate Restaurant
                      </Radio.Button>
                      <Radio.Button value="rating_asc">
                        Top Low Rate Restaurant
                      </Radio.Button>
                    </Radio.Group>
                  </div>
                </div>
              ...
              <div className="ant-list-box table-responsive">
                {radioValue == "user" && <TableUser></TableUser>}
                {radioValue == "rating_desc" && <TableRst></TableRst>}
                {radioValue == "rating_asc" && <TableRstAsc></TableRstAsc>}
              </div>
            </Card>
          </Col>
